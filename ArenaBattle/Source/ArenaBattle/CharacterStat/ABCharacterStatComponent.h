...
DECLARE_MULTICAST_DELEGATE_TwoParams(FOnStatChangeDelegate, const FABCharacterStat& /*BaseStat*/,
...
public:
	...
	{ BaseStat = BaseStat + InAddBaseStat; OnStatChanged.Broadcast(GetBaseStat(), GetModifierStat());}
	FORCEINLINE void SetBaseStat(const FABCharacterStat& InBaseStat)
	{ BaseStat = InBaseStat; OnStatChanged.Broadcast(GetBaseStat(), GetModifierStat()); }
